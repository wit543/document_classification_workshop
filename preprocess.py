...
N = len(os.listdir("sci.space.lemma.json")) + len(os.listdir("sci.electronics.lemma.json"))
corpus ={}
words = {}
for filename in os.listdir("sci.space.lemma.json"):
    with open("sci.space.lemma.json/"+filename,encoding="utf8") as input_file:
        word_temp = {}
        corpus_temp = {}
        for data_file in input_file:
            print(data_file)
...
for filename in os.listdir("sci.electronics.lemma.json"):
    with open("sci.electronics.lemma.json/"+filename) as input_file:
        word_temp = {}
        corpus_temp = {}
        count =0;
        for data_file in input_file:
